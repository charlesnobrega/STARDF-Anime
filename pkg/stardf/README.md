...
func main() {
    ...
    streamURL, metadata, err := client.GetEpisodeStreamURL(anime, episodes[0], &stardf.StreamOptions{
...
func main() {
    ...
    if len(episodes) > 0 {
        ...
        streamURL, metadata, err := client.GetEpisodeStreamURL(selectedAnime, episodes[0], &stardf.StreamOptions{
            Quality: "best",
            Mode:    "sub",
        })
        if err != nil {
...
#### `NewClient() *Client`
Creates a new StarDF client with all available scrapers initialized.
