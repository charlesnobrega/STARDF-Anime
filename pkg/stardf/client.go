// Package stardf provides a public API for anime scraping and searching functionality.
...
// NewClient creates a new StarDF-Anime client with all available scrapers
